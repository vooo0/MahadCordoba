          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h3 class="mb-2">{{ $pendaftaran->count() }} Calon Siswa</h3>
                <p><b>{{ $pendaftaran->where('status', '0')->count() }} Siswa</b> Tidak Diterima, 
                  <b>{{ $pendaftaran->where('status', '1')->count() }} Siswa</b> Belum Dikonfirmasi, 
                  <b>{{ $pendaftaran->where('status', '2')->count() }} Siswa</b> Diterima</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h3 class="mb-2">{{number_format($getSiswa->count())}} Siswa Terdaftar</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h3 class="mb-2">{{number_format($getGuru->count())}} Guru Terdaftar</h3>
              </div>
            </div>
          </div>
        </div>
