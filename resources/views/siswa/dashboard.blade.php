    ...
    <div class="row flex-grow">
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">Matapelajaran</h6>
            </div>
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h3 class="mb-2"> Matapelajaran Diambil</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">Nilai Tertinggi</h6>
            </div>
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">Nilai Terendah</h6>
            </div>
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h3 class="mb-2">65</h3>
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-baseline mb-2">
          <h6 class="card-title mb-0">Gaji</h6>
        </div>
        <p class="text-muted mb-4">Menghitung Gaji Pada Setiap BUlan Dalam Satu Tahun Terakhir.</p>
